	...
	public partial class FormExample : Form
    {
		...
		private void FinsembleConnected(object sender, EventArgs e)
		{
			...
			{ 
				...
				//setup a listener to determine if a window close event was triggered by finsemble or the user
				FSBL.RouterClient.AddListener("WindowService-Event-" + FSBL.windowName + "-close-requested", (s, args) =>
				{
